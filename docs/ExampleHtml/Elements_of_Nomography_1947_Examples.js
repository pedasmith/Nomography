...
function MakePage_30Diagram(svg)
{
    ...
    nomograph.ValidationInfo = "p30: U: 0...3..4L with 1 medium; W 0...8..10R with 1 large; V 0...5..6R 1 medium tick";
...
function MakePage_32TopDiagram(svg)
{
    ...
    var nomograph = new NomographTypeI(svg, -3.0, 0.5, -2.0, 1.5,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p32t: U: -3...-1..0L with 1 medium 1 small tick; W: -5...1..2R with 1 medium; V -2...0..1R with 1 medium 1 small tick";
    nomograph.Initialize();
    return nomograph;
}
...
function MakePage_32BottomDiagram(svg)
{
    ...
    var nomograph = new NomographTypeI(svg, 12.0, 15.5, 24, 27.5,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p32b: U: 12...14..15L with 1 medium 1 small; W: 36...42..43L with 1 medium; V: 24...26..27R with 1 medium 1 small";
    nomograph.Initialize();
    return nomograph;
}
...
function MakePage_34Diagram(svg)
{
    ...
    var nomograph = new NomographTypeI(svg, 0.0, 12.0, 0.0, 12.0,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p34: U: 0...10..12L with 1 medium 1 small; W: 0...22..24L with 1 medium; V: 0...10..12L with 1 medium 1 small";
    nomograph.Initialize();
    return nomograph;
}
...
function MakePage_36Diagram(svg)
{
    ...
    var nomograph = new NomographTypeI(svg, -27.0, 9.0, 18.0, 54.0,
        uTickSettings, vTickSettings, wTickSettings);
    nomograph.ValidationInfo = "p36: U: -20...-10..0L with 1 medium 4 small; W: 0...50..60L with 4 medium; V: 20...40..50L with 1 medium 4 small";
    nomograph.Initialize();
    return nomograph;
}
...
function MakePage_38Diagram(svg)
{
    ...
    var nomograph = new NomographTypeI(svg, -2.0, 2.0, -4.0, 4.0,
        uTickSettings, vTickSettings, wTickSettings);
    nomograph.ValidationInfo = "p38: U: -2...1..2L with 1 medium 4 small; V: 4...-3..-4L with 4 medium; W: 2...-1..-2L with 1 medium 4 small";
...
function MakePage_45Diagram(svg)
{
    ...
    var nomograph = new NomographTypeI(svg, 0.0, 6.0, 0.0, 12,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p45: U: 0...5..6L with 1 medium 4 small; W: 0...15..18L with 2 medium 1 small; V: 0...10..12L with 1 large 4 medium";
...
function MakePage_47Diagram(svg)
{
    ...
    var nomograph = new NomographTypeII(svg, -100, 200, 30, 60,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p47: U: -100...150..200L with 1 medium 4 small; W: -50...200..250R with 4 medium; V: 30...55..60L with 4 medium 1 small";
    nomograph.Initialize();
    return nomograph;
}
...
function MakePage_49Diagram(svg)
{
    ...
    var nomograph = new NomographTypeII(svg, 9.73, 18.16, 33.3, 38.9,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p49: U: 10...17..18L with 4 medium; W 44...54..56R with 1 medium 4 small; V: 34...37..38L with 1 medium 4 small";
    nomograph.Initialize();
    return nomograph;
}
...
function MakePage_53Diagram(svg)
{
    ...
    var nomograph = new NomographTypeII(svg, 0.0, 6.0, 0.0, 4.0,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p53: P: 0...5..6L with 1 medium 4 small; R: 5...15..20L with 4 medium 1 small; Q: 0...3..4L with 1 medium 4 small";
...
function MakePage_56Diagram(svg)
{
    ...
    var nomograph = new NomographTypeII(svg, 2.0, 5.0, 1.0, 4.0,
        uTickSettings, vTickSettings, wTickSettings); 
    nomograph.ValidationInfo = "p56: P: 2...4..5 log with 1 medium 4 small; R: -4...4..6 every 2 with 1 medium 4 small; Q: 4...2..1 with 1 medium 4 small";
